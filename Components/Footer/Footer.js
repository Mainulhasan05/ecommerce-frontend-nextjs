            ...
            <div className="row">
                <div className="col-lg-3 col-md-6 col-sm-6">
                    <div className="footer__about">
                        ...
                        <ul>
                            <li>Address: Chapai Nawabganj Sadar</li>
                            <li>Phone: +8801757995016</li>
                            <li>Email: mdrifatbd5@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="col-lg-4 col-md-12">
                    <div className="footer__widget">
                        ...
                        <div className="footer__widget__social">
                            <a href="https://www.facebook.com/SuchonaMartOfficial" target='_blank'><i className="fa fa-facebook"></i></a>
